var users = {
  PhilArcadian: 'Phil Arcadian',
  ZoeyPierson: 'Zoey Pierson',
  TedMosby: 'Ted Mosby',
  LilyAldrin: 'Lily Aldrin',
  MarshallEriksen: 'Marshall Eriksen',
  RobinScherbatsky: 'Robin Scherbatsky',
  BarneyStinson: 'Barney Stinson'
}
